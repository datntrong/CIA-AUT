...
import uet.fit.aut.autogen.testdatagen.RandomValue;
import uet.fit.aut.autogen.testdatagen.RandomValueForAssignment;
import uet.fit.aut.autogen.testdatagen.RandomValueForSizeOf;
...
public class ValueToTestcaseConverter_UnknownSize {
    final static AUTLogger logger = AUTLogger.get(RandomValue.class);

    private Map<String, String> testcases = new HashMap<>();

    public static void main(String[] args) {
        String testcases = "b[9]=5;b[9][4]=3;b=10";
