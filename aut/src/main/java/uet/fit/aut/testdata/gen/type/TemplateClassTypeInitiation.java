...
import uet.fit.aut.testdata.object.TemplateClassDataNode;
...
//        }
        ...
        INode coreTypeNode = vParent.getCorrespondingNode();
...
//        child.setType(vParent.getFullType());
        child.setRawType(TemplateUtils.getTemplateFullRawType(vParent));
