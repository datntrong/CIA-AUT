...
//                    + child.getName() + SpecialCharacter.LINE_BREAK;
                ...
                declaration += getVirtualName() + SpecialCharacter.DOT + this.getPushMethod()
                        + "(" + child.getVirtualName() + ")"
                        + SpecialCharacter.END_OF_STATEMENT + SpecialCharacter.LINE_BREAK;
            }
        }
...
//
//            // init iterator
//            output += String.format("%s::iterator AUT_TEMP_ITERATOR = %s.begin();\n", type, actualOutputName);
//
