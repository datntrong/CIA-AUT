...
import uet.fit.aut.parser.normalizer.Cpp11ClassNormalizer;
...
public class SourcecodeFileParser implements ISourcecodeFileParser {
    final static AUTLogger logger = AUTLogger.get(SourcecodeFileParser.class);
...
//    }
//
//    private void appendMacroDefinition(Map<String, String> map) {
//        macros.putAll(map);
//    }
//
