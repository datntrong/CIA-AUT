...
import uet.fit.aut.autogen.testdatagen.structuregen.ChangedToken;
import uet.fit.aut.autogen.testdatagen.structuregen.ChangedVariableToken;
...
public class ClassvsStructNormalizer extends AbstractFunctionNormalizer
    ...
    final static AUTLogger logger = AUTLogger.get(ProjectParser.class);
