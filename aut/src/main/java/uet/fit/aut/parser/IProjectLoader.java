...
public interface IProjectLoader {
    ...
    String CPP_IGNORE_FILE_SYMBOL = ".autignore.cpp";
    String CC_IGNORE_FILE_SYMBOL = ".autignore.cc";
    String C_IGNORE_FILE_SYMBOL = ".autignore.c";
    ...
    String H_IGNORE_FILE_SYMBOL = ".autignore.h";
    String HH_IGNORE_FILE_SYMBOL = ".autignore.hh";
    String HHP_IGNORE_FILE_SYMBOL = ".autignore.hpp";
