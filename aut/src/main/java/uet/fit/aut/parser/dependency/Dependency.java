...
public class Dependency {
    ...
    public String toString() {
        return "[" + getClass().getSimpleName() + "]:\t" + "[" + startArrow.getClass().getSimpleName() + "] "
                + IdMapping.getInstance().getOrCreate(startArrow.getName()) + " -> "
                + "[" + endArrow.getClass().getSimpleName() + "] "
                + IdMapping.getInstance().getOrCreate(endArrow.getName());
    }
