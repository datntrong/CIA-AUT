...
//                    logger.debug("Ignore " + IdMapping.getInstance().getOrCreate(child.getName()));
                }
            }
...
//    }
    ...
    public static List<SubprogramNode> searchStubableSubprograms(RootDataNode root) {
        ...
        subprograms.removeIf(f -> f instanceof ConstructorDataNode || f.isSut() || f instanceof IterationSubprogramNode);
