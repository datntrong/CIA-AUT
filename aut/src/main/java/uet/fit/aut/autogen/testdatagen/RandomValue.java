...
//        logger.debug("Added " + this.toString());
    ...
    public String toString() {
        return "nameUsedInExpansion = \"" + IdMapping.getInstance().getOrCreate(getNameUsedInExpansion()) + "\"; " +
                "nameUsedInCode = \"" + IdMapping.getInstance().getOrCreate(nameUsedToUpdateValue) + "\", " +
                "value = \"" + IdMapping.getInstance().getOrCreate(value) + "\"\n";
    }
}
