package uet.fit.aut.autogen.testdatagen.se.expander;

import uet.fit.aut.autogen.testdatagen.se.CustomJeval;
 ...
 * @author DucAnh
 */
public class ArrayIndexExpander extends uet.fit.aut.autogen.testdatagen.se.expander.AbstractPathConstraintExpander implements IPathConstraintExpander {

    public static void main(String[] args) {
        uet.fit.aut.autogen.testdatagen.se.expander.AbstractPathConstraintExpander expander = new ArrayIndexExpander();
    ...
    private List<String> getIndexofArrayItemConstraints(String constraint) {
        ...
        List<ICPPASTArraySubscriptExpression> arrayItems = ASTUtils
                .getArraySubscriptExpression(Utils.convertToIAST(constraint));
