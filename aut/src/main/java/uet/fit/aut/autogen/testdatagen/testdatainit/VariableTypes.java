package uet.fit.aut.autogen.testdatagen.testdatainit;

import uet.fit.aut.autogen.testdatagen.testdatainit.VariablesSize.BASIC.NUMBER.INTEGER;
...
public class VariableTypes {
    ...
    public static void main(String[] args) {
        for (String s : VariableTypes
                .getAllBasicFieldNames(BASIC.class))
    ...
    public static boolean isChOneLevel(String rawType) {
        ...
        for (String type : VariableTypes.getAllBasicFieldNames(BASIC.CHARACTER.class)) {
    ...
    public static boolean isNumBasic(String rawType) {
        ...
        for (String type : VariableTypes.getAllBasicFieldNames(BASIC.NUMBER.class)) {
            String[] types = new String[]{type,
                    type + VariableTypes.REFERENCE};
            for (String typeItem : types)
                if (rawType.equals(typeItem))
    ...
    public static boolean isNumBasicInt(String rawType) {
        rawType = VariableTypes.deleteUnionKeywork(rawType);
        rawType = VariableTypes.deleteStructKeywork(rawType);
        rawType = VariableTypes.deleteStorageClasses(rawType);
        rawType = VariableTypes.deleteSizeFromArray(rawType);

        for (String type : VariableTypes.getAllBasicFieldNames(INTEGER.class)) {
            String[] types = new String[]{type,
                    type + VariableTypes.REFERENCE};
            for (String typeItem : types)
                if (rawType.equals(typeItem))
    ...
    public static boolean isNumBasicFloat(String rawType) {
        ...
        for (String type : VariableTypes.getAllBasicFieldNames(BASIC.NUMBER.FLOAT.class)) {
            String[] types = new String[]{type,
                    type + VariableTypes.REFERENCE};
            for (String typeItem : types)
                if (rawType.equals(typeItem))
