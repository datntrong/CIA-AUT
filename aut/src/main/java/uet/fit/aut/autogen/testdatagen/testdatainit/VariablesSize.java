...
public class VariablesSize {
    ...
    public static int getSizeofTypeInByte(String rawType) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (VariableTypeUtils.isNumBasic(rawType) || VariableTypeUtils.isChBasic(rawType))
            for (java.lang.reflect.Field typeItem : VariableTypeUtils.getAllBasicFields(BASIC.class)) {
                /*
