 ...
 * @author ducanh
 */
public abstract class CfgNode implements ICfgNode, Cloneable {

	private String content;

	private ICfgNode defaultNodeDefined = null;
	...
	@Override
	public void setDefaultNode(ICfgNode node) {
		defaultNodeDefined = node;
	}

	@Override
	public ICfgNode getDefaultNode() {
		return defaultNodeDefined;
	}
	...
	public boolean isSpecialCfgNode() {
		return !(this instanceof NormalCfgNode);
	}
