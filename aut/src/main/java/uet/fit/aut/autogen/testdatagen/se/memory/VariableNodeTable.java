...
import uet.fit.aut.autogen.testdatagen.se.memory.array.one_dim.OneDimensionZ3ToIntSymbolicVariable;
...
public class VariableNodeTable extends ArrayList<ISymbolicVariable> implements IVariableNodeTable {
	final static AUTLogger logger = AUTLogger.get(VariableNodeTable.class);
	/**
	 *
	 */
