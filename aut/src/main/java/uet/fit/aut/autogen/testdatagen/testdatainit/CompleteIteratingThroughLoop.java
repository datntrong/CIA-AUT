...
import static uet.fit.aut.autogen.testdatagen.ConcolicAutomatedTestdataGeneration.toDescription;

public class CompleteIteratingThroughLoop {

    private final static AUTLogger logger = AUTLogger.get(CompleteIteratingThroughLoop.class);
