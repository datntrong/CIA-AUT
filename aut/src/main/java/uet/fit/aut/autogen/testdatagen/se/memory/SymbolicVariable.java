package uet.fit.aut.autogen.testdatagen.se.memory;

import uet.fit.aut.autogen.testdatagen.se.memory.array.multiple_dims.*;
import uet.fit.aut.autogen.testdatagen.se.memory.array.one_dim.*;
import uet.fit.aut.autogen.testdatagen.se.memory.basic.CharacterSymbolicVariable;
import uet.fit.aut.autogen.testdatagen.se.memory.basic.NumberSymbolicVariable;
import uet.fit.aut.autogen.testdatagen.se.memory.pointer.*;
import uet.fit.aut.autogen.testdatagen.se.memory.structure.ClassSymbolicVariable;
import uet.fit.aut.autogen.testdatagen.se.memory.structure.EnumSymbolicVariable;
import uet.fit.aut.autogen.testdatagen.se.memory.structure.StructSymbolicVariable;
...
//	}
	...
	private static final AUTLogger logger = AUTLogger.get(SymbolicVariable.class);
				...
				if (VariableTypeUtils.isChBasic(realType))
					...
					if (VariableTypeUtils.isStructureSimple(realType)) {
						...
						if (nodeType instanceof UnionNode)
							v = new UnionSymbolicVariable(name, realType, scopeLevel);
