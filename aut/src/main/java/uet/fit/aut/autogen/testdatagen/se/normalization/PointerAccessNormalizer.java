...
import uet.fit.aut.parser.normalizer.AbstractFunctionNormalizer;
import uet.fit.aut.parser.normalizer.IFunctionNormalizer;
...
public class PointerAccessNormalizer extends AbstractFunctionNormalizer implements IFunctionNormalizer {
    ...
    private String convertOneLevelPointerAccessToArrayItem(String statement) throws Exception {
        ...
        List<ICPPASTUnaryExpression> unaryExpressions = ASTUtils.getUnaryExpressions(Utils.convertToIAST(statement));
