...
import uet.fit.aut.autogen.cfg.object.AbstractConditionLoopCfgNode;
import uet.fit.aut.autogen.cfg.object.ICfgNode;
import uet.fit.aut.autogen.testdatagen.testdatainit.CompleteIteratingThroughLoop;
...
public abstract class ConcolicAutomatedTestdataGeneration extends SymbolicExecutionTestdataGeneration {
    ...
    private final static AUTLogger logger = AUTLogger.get(ConcolicAutomatedTestdataGeneration.class);
    ...
    protected List<TestCase> generateInitialTestCases() {
        ...
        ExecuteTestTask task = new ExecuteTestTask(buildConfig, environment, workspace, projectConfig, emptyTestCase);
    ...
    protected void start(List<TestCase> testCases, ICommonFunctionNode fn, String coverageType,
         ...
         * Generate directly
         */
//        if (new File(Locations.Z3_PATH).exists()) {
...
//        }
        ...
        try {
            ...
            minimizer.clean(coverageType, newTestCases, Scope.SOURCE);
