...
public class EnterTestDataTask extends LogableCallAPITask<TestDataDTO> {

	private final String testCaseId;
	private final String path;
	private final String value;

	public EnterTestDataTask(String testCaseId, String path, String value, String username) {
		super(username);
	...
	protected Response request() throws Exception {
		return HttpUtils.enterTestData(testCaseId, path, value, username);
	}
